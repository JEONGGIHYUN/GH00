...
random_state=888
x_train, x_test, y_train, y_test = train_test_split(x_pf, y, train_size=0.8, random_state= random_state, stratify=y)
...
# 예측 점수 : 0.8641197321780228
# 스태킹 결과 : 0.8641197321780228
