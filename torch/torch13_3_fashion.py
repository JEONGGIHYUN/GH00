...
print(train_dataset[0]) # (<PIL.Image.Image image mode=L size=28x28 at 0x25D13693230>, 9)
print(train_dataset[0][0]) # <PIL.Image.Image image mode=L size=28x28 at 0x25D13693230>
