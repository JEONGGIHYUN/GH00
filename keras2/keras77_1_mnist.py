...
from tensorflow.keras.layers import Dense, Conv2D, Flatten,Reshape,Conv1D,GlobalAveragePooling1D
...
#2. 모델
model = Sequential()
model.add(Conv2D(64, (3,3), input_shape=(28, 28, 1))) # 27, 27 , 10
...
model.add(Reshape(target_shape=(529,32)))
model.add(Conv1D(filters=10,kernel_size=2,input_shape=(529,32)))
#########
...
# Conv1D
# r2_score :  0.9622271486983671
# loss : [0.06576110422611237, 0.9829999804496765]
# acc score : 0.9822