...
from tensorflow.keras.layers import Dense, Conv2D, MaxPooling2D,Flatten, Dropout, Reshape, Conv1D,GlobalAveragePooling2D
...
submission_csv.to_csv(path_csv + 'submission_0813_17.csv')
