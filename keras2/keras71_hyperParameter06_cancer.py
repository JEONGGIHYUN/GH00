...
# 걸린시간 :  10.63
# model.best_params_ {'optimizer': 'rmsprop', 'node5': 5, 'node4': 65, 'node3': 32, 'node2': 2, 'node1': 64, 'drop': 0.3, 'batch_size': 300, 'activation': 'relu'}
# model.best_estimator_ <keras.wrappers.scikit_learn.KerasRegressor object at 0x000001E0FB1FBAF0>
# model.best_score_ -0.6225255012512207
# 1/1 [==============================] - 0s 55ms/step - loss: 0.6047 - mae: 0.6047
# model.score -0.6046992540359497