...
#2. 모델
model = Sequential()
model.add(Conv2D(64, (4,4), input_shape=(28, 28, 1))) # 27, 27 , 10
...
model.add(Reshape(target_shape=(529,64)))
model.add(Conv1D(filters=10,kernel_size=2,input_shape=(529,64)))
#########
...
# Conv1D
# r2_score :  0.7643333200181102
# loss : [0.3305317759513855, 0.8920999765396118]
# acc score : 0.8809